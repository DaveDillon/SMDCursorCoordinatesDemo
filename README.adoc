...
This poject was created to help me better understand sprite movement and screen coordinates as well as the perils of 
...
- Free Mode: Allows the cursor the free roam the screen.
* Debug text 
...
- Based on learngins from wathcing Pigsy's Retro Game Dev Tutorials / https://www.youtube.com/@PigsysRetroGameDevTutorials